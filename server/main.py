"""Wolfgang Rush — Motor Accident Claims Tribunal Drafting MCPB.
...
FULL_ORCHESTRATION_SCRIPT = """# WOLFGANG RUSH — INDIAN MOTOR ACCIDENT CLAIMS TRIBUNALS DRAFTING · FULL ORCHESTRATION SCRIPT
